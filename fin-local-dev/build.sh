...
CORE_SERVER_REPO_TAG="local-dev"
UCD_LIB_SERVER_REPO_TAG="local-dev"
LORIS_SERVICE_REPO_TAG="local-dev"
TESSERACT_SERVICE_REPO_TAG="local-dev"
CAS_SERVICE_REPO_TAG="local-dev"
