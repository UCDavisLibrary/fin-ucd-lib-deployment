...
CORE_SERVER_REPO_TAG=v2.0-sandbox
UCD_LIB_SERVER_REPO_TAG=v2.0-sandbox
...
UCD_LIB_NODE_UTILS_IMAGE_NAME=$UCD_LIB_DOCKER_ORG/fin-ucd-lib-node-utils
UCD_LIB_API_IMAGE_NAME=$UCD_LIB_DOCKER_ORG/fin-ucd-lib-api
...
ALL_DOCKER_BUILD_IMAGES=( \
 ...
 $UCD_LIB_NODE_UTILS_IMAGE_NAME $UCD_LIB_API_IMAGE_NAME
)
